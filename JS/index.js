...
window.addEventListener("load", async function () {
    ...
    try {
        ...
        data1 = await getData(`https://api.trakt.tv/calendars/all/movies/${year}-${month}-${day}?extended=full,images`);
        console.log(data1);
        data2 = await getData(`https://api.trakt.tv/calendars/all/shows/premieres/${year}-${month}-${day}?extended=full,images`);
        console.log(data2);
        data = combineData(data1, data2);
